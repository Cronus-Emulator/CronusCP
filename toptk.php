<div id="content-title">Ranking Taekwon</div>
<div id="content-html">
  <table width="100%" border="0" cellpadding="3" cellspacing="5" id="whoisonline">
	...
	$sql = $mysql->mysqlQuery( "SELECT `name`, `base_level`, `job_level`, `fame`, `online` FROM `char` WHERE `fame` >= '1' AND `class` = '4046' ORDER BY `fame` DESC LIMIT 0,{$j}" );
